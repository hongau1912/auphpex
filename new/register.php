                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 separator">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength="9" maxlength="11" class="form-control" name="phone" placeholder="Nhập số điện thoại của bạn" required />
                                        </div>
                                    </div><!-- /form-group -->
